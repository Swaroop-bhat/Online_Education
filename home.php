...
<body>
	<header id="header">
		...
		<div class="head-container">
			<div class="quote">
				<p>ಕನ್ನಡದಲ್ಲಿ ಇಂಜಿನಿಯರಿಂಗ್ ಕಲಿಯಿರಿ.</p><br />
				<h3>Portal to learn Engineering in Kannada.</h3>
				<div class="play">
					<img src="images/icon/play.png" alt="play"><span><a href="https://youtu.be/tx61kRUNfCE"
	...
	<div class="course">
		<center>
			<div class="cbox">
				<div class="det"><a href="https://www.geeksforgeeks.org/computer-network-tutorials/"><img
							src="images/courses/book.png">Computer Networks</a></div>
				<div class="det"><a href=""><img src="images/courses/d1.png">Operating System</a></div>
				<div class="det"><a
						href="https://practice.geeksforgeeks.org/courses/competitive-programming-live?utm_source=GfG&utm_medium=gfg_submenu&utm_campaign=DS_Submenu/"><img
							src="images/courses/paper.png">Competitive Programming</a></div>
				<div class="det"><a href="https://www.geeksforgeeks.org/dbms/"><img src="images/courses/d1.png">Database
		...
		<div class="cbox">
			<div class="det"><a href="subjects/computer_courses.html"><img src="images/courses/computer.png">Computer
					Courses</a></div>
			<div class="det"><a href="https://www.geeksforgeeks.org/data-structures/?ref=shm"><img
						src="images/courses/data.png">Data Structures</a></div>
			<div class="det"><a href="https://www.geeksforgeeks.org/fundamentals-of-algorithms/?ref=shm"><img
						src="images/courses/algo.png">Algorithm</a></div>
			<div class="det det-last"><a href="https://www.geeksforgeeks.org/computer-science-projects/?ref=sh"><img
	...
	<div class="diffSection" id="about_section">
		...
		<div class="about-content">
			...
			<div class="side-text">
				...
				<p>ಶಿಕ್ಷಣವು ಕಲಿಕೆಯನ್ನು ಸುಗಮಗೊಳಿಸುವ ಪ್ರಕ್ರಿಯೆಯಾಗಿದೆ, ಅಥವಾ ಜ್ಞಾನ, ಕೌಶಲ್ಯಗಳು, ಮೌಲ್ಯಗಳು, ನಂಬಿಕೆಗಳು ಮತ್ತು
					ಅಭ್ಯಾಸಗಳನ್ನು
					ಪಡೆದುಕೊಳ್ಳುವುದು. ಶೈಕ್ಷಣಿಕ ವಿಧಾನಗಳಲ್ಲಿ ಬೋಧನೆ, ತರಬೇತಿ, ಕಥೆ ಹೇಳುವಿಕೆ ಸೇರಿವೆ. 

					ಶೈಕ್ಷಣಿಕ ವೆಬ್‌ಸೈಟ್ ಆಟಗಳು, ವೀಡಿಯೊಗಳು ಅಥವಾ ವಿಷಯ ಸಂಬಂಧಿತ ಸಂಪನ್ಮೂಲಗಳನ್ನು ಹೊಂದಿರುವ ವೆಬ್‌ಸೈಟ್‌ಗಳನ್ನು
					ಒಳಗೊಂಡಿರಬಹುದು, ಅದು
					ಕಲಿಕೆಯನ್ನು ವರ್ಧಿಸಲು ಮತ್ತು ತರಗತಿಯ ಬೋಧನೆಗೆ ಪೂರಕವಾಗಿದೆ. ಈ ವೆಬ್‌ಸೈಟ್‌ಗಳು ಕಲಿಕೆಯ ಪ್ರಕ್ರಿಯೆಯನ್ನು ವಿಶೇಷವಾಗಿ
					ಇಂದಿನ ಯುಗದಲ್ಲಿ
					ವಿದ್ಯಾರ್ಥಿಗೆ ಮನರಂಜನೆ ಮತ್ತು ಆಕರ್ಷಕವಾಗಿಸಲು ಸಹಾಯ ಮಾಡುತ್ತದೆ.</p>
			</div>
		</div>
	</div>
	...
	<div class="service-swipe">
		<div class="diffSection" id="services_section">
			<center>
				<p style="font-size: 50px; padding: 100px; padding-bottom: 40px; color: #fff;">ವಿಭಾಗಗಳು</p>
			</center>
		</div>
		<a href="view.php">
			<div class="s-card"><img src="images/icon/computer-courses.png">
			  <a href="view.php"><p>ಕಂಪ್ಯೂಟರ್ ಸೈನ್ಸ್ ಮತ್ತು ಇಂಜಿನಿಯರಿಂಗ್.</p></a>	
			</div>
		</a>
		<a href="ISE_view.php">
	...
	<marquee style="background: linear-gradient(to right, #FA4B37, #DF2771); margin-top: 50px;" direction="left"
		...
		<div class="marqu">“ಪ್ರತಿಯೊಬ್ಬ ವ್ಯಕ್ತಿಯು ಎರಡು ರೀತಿಯ ಶಿಕ್ಷಣ ಹೊಂದುತ್ತಾನೆ. ಒಂದು ಇತರರು ಅವನಿಗೆ ನೀಡುವುದು. ಇನ್ನೊಂದು
			ಸ್ವಂತ ಅವನು ಕಲಿಯುವುದು”</div>
	</marquee>
